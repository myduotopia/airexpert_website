...
values
  (
    ...
    '[{"url":"/services/hero-energy-plan.jpg","alt":"工程師在明亮廠房檢視空壓機能耗報表","sort":0},{"url":"/services/energy-plan-steps.svg","alt":"三步驟節能規劃流程圖：洽談諮詢、現場勘查、報告製作","sort":1}]'::jsonb,
    '節能方案規劃 | 超勁賀空壓科技',
  ...
  (
    ...
    '[{"url":"/services/hero-energy-tech.jpg","alt":"雙段壓縮空壓機內部剖視","sort":0},{"url":"/services/energy-tech-compare.svg","alt":"雙段壓縮與單段壓縮能耗對比圖","sort":1},{"url":"/services/energy-tech-dryer.svg","alt":"儲能型與傳統型冷凍式乾燥機差異對比","sort":2}]'::jsonb,
    '突破傳統的節能技術 | 超勁賀空壓科技',
  ...
  (
    ...
    '[{"url":"/services/hero-room-planning.jpg","alt":"規劃整齊的空壓機房與儲氣桶","sort":0},{"url":"/services/room-planning-layout.svg","alt":"後處理設備建議配置順序流程圖","sort":1},{"url":"/services/room-planning-loop.svg","alt":"環狀主幹管管路佈置示意圖","sort":2}]'::jsonb,
    '從源頭規劃的氣源機房 | 超勁賀空壓科技',
  ...
  (
    ...
    '[{"url":"/services/hero-carbon-reduction.jpg","alt":"智能能源管理系統即時能耗監控螢幕","sort":0},{"url":"/services/carbon-reduction-flow.svg","alt":"空壓設備碳盤查六步驟流程圖","sort":1},{"url":"/services/carbon-reduction-devices.svg","alt":"智能量測設備生態圖：智能群控箱與各式量測設備","sort":2}]'::jsonb,
    '以數據驅動的減碳行動 | 超勁賀空壓科技',
