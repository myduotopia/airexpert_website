  ...
  return (
    <section className="bg-surface-dark">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-[18px] px-6 py-16 text-center md:px-20">
        <h2 className="max-w-[760px] text-[28px] leading-tight font-bold text-white md:text-[36px]">
          {title}
        </h2>
        <p className="text-text-on-dark-muted max-w-[620px] text-[16px] leading-[1.6]">
          {description}
        </p>
        <Link
          href="/contact"
          className="bg-primary-deep focus-visible:ring-primary-soft mt-2 inline-flex items-center justify-center gap-2 rounded-[26px] px-7 py-[15px] text-[15px] font-semibold text-white transition-opacity hover:opacity-90 focus-visible:ring-2 focus-visible:outline-none"
        >
          {ctaLabel}
