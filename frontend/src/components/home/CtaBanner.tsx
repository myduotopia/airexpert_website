  ...
  return (
    <section className="bg-surface-dark">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-[18px] px-6 py-16 text-center md:px-20">
        ...
        <Link
          href="/contact"
          className="bg-primary-deep mt-2 inline-flex items-center justify-center gap-2 rounded-[26px] px-7 py-[15px] text-[15px] font-semibold text-white transition-opacity hover:opacity-90"
        >
          預約能源診斷
