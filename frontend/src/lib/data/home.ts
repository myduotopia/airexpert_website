...
export const HOME_DEFAULTS: HomeContent = {
    ...
    slides: [
      {
        ...
        alt: "明亮空壓機房中，涼色能量光流自空壓機湧出，象徵電費成本",
        category: "電費過高",
  ...
  stats: {
    items: [
      ...
      { value: "550萬度+", label: "累積節能度數" },
      { value: "63%", label: "最高節能率" },
      { value: "1,000+", label: "輔導客戶數" },
    ],
  },
  tech: {
