...
const PMV_ROWS: string[][] = [
  ...
  ["PMV-30", "6~9", "3.61~4.22", "22 / 30", "G1", "68", "480"],
  ["PMV-50", "6~9", "6.28~7.42", "37 / 50", "G1½", "70", "710"],
  ["PMV-75", "6~9", "9.99~11.95", "55 / 75", "G1½", "70", "990"],
];

// 永磁變頻二段螺旋空氣壓縮機 (PMV2).
const PMV2_ROWS: string[][] = [
  ["PMV2-30", "6~9", "3.8~4.6", "22 / 30", "G1", "", "550"],
  ["PMV2-50", "6~9", "6.5~7.65", "37 / 50", "G1½", "", "740"],
  ["PMV2-75", "6~9", "10.5~12.5", "55 / 75", "G1½", "", "1100"],
...
const PCM_ROWS: string[][] = [
  ...
  ["PCM3.5", "3.5", "0.64", 'PT1"', "66.5", "712×363×782"],
  ["PCM6.8", "6.83", "1.30", 'PT2"', "98.5", "762×443×962"],
  ["PCM14.1", "14.14", "2.55", 'PT2"', "152", "912×494×1112"],
  ["PCM18.9", "18.9", "3.53", 'PT2"', "192", "1032×494×1253"],
  ["PCM28.1", "28.1", "4.50", "80A", "514", "1600×820×1394"],
  ["PCM42.7", "42.7", "6.50", "100A", "850", "1860×1000×1382"],
  ["PCM49.9", "49.9", "", "100A", "870", ""],
  ["PCM66.5", "66.54", "10.50", "100A", "1200", "1860×1120×1802"],
