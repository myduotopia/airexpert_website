// 自動產生（scratchpad/gen_testing_data.py）— 服務項目改版「測試預覽」資料。
// 內容鏡射 supabase/seeds/services.sql；此頁不讀 DB，正式 /services 不受影響。
// 待改版定案並套用 seed 後，可連同 services-testing 目錄一併刪除。
...
export const previewServices: PreviewService[] = [
  {
    ...
    body: `<p>空壓系統往往是工廠裡最容易被忽略、卻最耗電的一環。管路佈置若在規劃或施工初期未能妥善配置，日後一旦發生洩漏、腐蝕或壓降，除了重新配管幾乎無計可施，能源就這樣一點一滴流失。超勁賀相信「節能不是換一台機器，而是重新理解整套系統」，因此我們以三個步驟，陪客戶從觀念釐清開始，逐步找出真正適合每間工廠的省電方案。</p><h2>三步驟節能規劃</h2><p>每一步都以實測數據為依據，讓節能決策不再憑感覺，而是看得見、算得出。</p><h3>1. 洽談諮詢 · 觀念釐清</h3><p>先深入了解廠內的用氣需求、使用習慣與現有空壓機狀況，釐清常見的節能迷思，並提供初步評估與後續規劃方向。這一步不急著談設備，而是先把問題定義清楚。</p><h3>2. 現場勘查 · 效能檢測</h3><p>實地評估工廠環境中油氣與溫度對空壓機的影響，並以專業儀器檢測空壓機及乾燥機的排氣量、露點等級與耗電狀況，讓每一項能源損耗都有具體數字佐證。</p><h3>3. 報告製作 · 會議討論</h3><p>將檢測數據整理成智能分析報告，清楚呈現廠內各機台的運轉現況與改善空間，再與客戶一同討論、排定優先順序，訂出投資報酬最合理的節能方案。</p><p>從第一次對談到最終方案，超勁賀提供的不只是設備建議，而是一套可被驗證、可持續優化的節能路徑。</p>`,
    images: [
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/hero-energy-plan.jpg",
        alt: "工程師在明亮廠房檢視空壓機能耗報表",
      },
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/energy-plan-steps.svg",
        alt: "三步驟節能規劃流程圖：洽談諮詢、現場勘查、報告製作",
      },
    ],
  },
  {
    ...
    body: `<p>節能的下一步，往往藏在「機器怎麼運作」的細節裡。繼變頻技術之後，超勁賀導入雙段壓縮與儲能型乾燥兩項關鍵技術，從壓縮與除濕兩端同時降低能耗，讓省電不必犧牲產氣量與空氣品質。</p><h2>空壓機雙段與單段壓縮的差異</h2><p>在相同排氣量下，雙段壓縮的排氣量比單段更大，因此同馬力數的雙段壓縮負荷量小於單段，耗電量可降低 <strong>15~20%</strong>。以一台 100HP 空壓機、每年運轉 6336 小時計算，實測年運轉電力可節省 <strong>82,685 kW</strong> —— 相當於一筆年復一年、持續回收的能源成本。</p><h2>儲能型與傳統型冷凍式乾燥機的差異</h2><p>乾燥機是另一個常被忽略的耗電來源。儲能型利用 PCM 相變材料，讓冷媒壓縮機擁有「休息」的節電空間，可依廠內用氣量彈性休息或運轉；在不影響效能的前提下，卻水效果比傳統型提升 <strong>10~20%</strong>。</p><ul><li><strong>傳統型：</strong>製冷壓縮機與風扇必須持續作動，才能維持冷媒效能，即使用氣量下降也照樣耗電。</li><li><strong>儲能型：</strong>冷媒先冷卻 PCM 並使其凍結，凍結期間壓縮機與風扇即停止；PCM 吸收壓縮空氣熱能的過程完全不耗功率，待其融化後才恢復運轉，用電因此大幅下降。</li></ul>`,
    images: [
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/hero-energy-tech.jpg",
        alt: "雙段壓縮空壓機內部剖視",
      },
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/energy-tech-compare.svg",
        alt: "雙段壓縮與單段壓縮能耗對比圖",
      },
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/energy-tech-dryer.svg",
        alt: "儲能型與傳統型冷凍式乾燥機差異對比",
      },
      {
        url: "https://jgqswfjdehtpesfdlmhe.supabase.co/storage/v1/object/public/media/services/tech-cutaway.jpg",
        alt: "雙段壓縮主機剖視：高效主機設計與級間冷卻",
      },
    ],
  },
  {
